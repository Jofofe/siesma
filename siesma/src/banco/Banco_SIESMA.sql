...
ALTER TABLE PROFESSOR_DISCIPLINA ADD CONSTRAINT FK_PROFESSOR_DISCIPLINA_EMPREGADO FOREIGN KEY (ID_USUARIO) REFERENCES EMPREGADO (ID_USUARIO);
...
CREATE TABLE FORMA_PAGAMENTO (
	...
	QTD_PARECELAS INTEGER NOT NULL,
	DT_INICIO TIMESTAMP NOT NULL,
	DT_FIM TIMESTAMP NOT NULL
);
...
--	NOME_LANCAMENTO VARCHAR(50) NOT NULL,
--	UNIDADE_MEDIDA VARCHAR(50) NOT NULL,
--	QTD_RELACIONADA INTEGER NOT NULL,
...
CREATE TABLE PAGAMENTO_ALUNO (
	ID_PAGAMENTO_ALUNO BIGINT PRIMARY KEY NOT NULL,
	ID_ALUNO BIGINT NOT NULL,
	ID_LANCAMENTO_COMERCIAL BIGINT NOT NULL
)

CREATE SEQUENCE PAGAMENTO_ALUNO_ID_SEQ;
ALTER TABLE PAGAMENTO_ALUNO ALTER COLUMN ID_PAGAMENTO_ALUNO SET DEFAULT NEXTVAL('PAGAMENTO_ALUNO_ID_SEQ');
ALTER TABLE PAGAMENTO_ALUNO ADD CONSTRAINT FK_PAGAMENTO_ALUNO_ALUNO FOREIGN KEY (ID_ALUNO) REFERENCES ALUNO (ID_USUARIO);
ALTER TABLE PAGAMENTO_ALUNO ADD CONSTRAINT FK_PAGAMENTO_ALUNO_LANCAMENTO FOREIGN KEY (ID_LANCAMENTO_COMERCIAL) REFERENCES LANCAMENTO_COMERCIAL (ID_LANCAMENTO_COMERCIAL);

CREATE TABLE PAGAMENTO_PROFESSOR (
	ID_PAGAMENTO_PROFESSOR BIGINT PRIMARY KEY NOT NULL,
	ID_PROFESSOR BIGINT NOT NULL,
	ID_LANCAMENTO_COMERCIAL BIGINT NOT NULL
)

CREATE SEQUENCE PAGAMENTO_PROFESSOR_ID_SEQ;
ALTER TABLE PAGAMENTO_PROFESSOR ALTER COLUMN ID_PAGAMENTO_PROFESSOR SET DEFAULT NEXTVAL('PAGAMENTO_PROFESSOR_ID_SEQ');
ALTER TABLE PAGAMENTO_PROFESSOR ADD CONSTRAINT FK_PAGAMENTO_PROFESSOR_PROFESSOR FOREIGN KEY (ID_PROFESSOR) REFERENCES EMPREGADO (ID_USUARIO);
ALTER TABLE PAGAMENTO_PROFESSOR ADD CONSTRAINT FK_PAGAMENTO_PROFESSOR_LANCAMENTO FOREIGN KEY (ID_LANCAMENTO_COMERCIAL) REFERENCES LANCAMENTO_COMERCIAL (ID_LANCAMENTO_COMERCIAL);