...
ALTER TABLE LANCAMENTO_COMERCIAL ADD CONSTRAINT FK_LANCAMENTO_COMERCIAL_ALUNO FOREIGN KEY (ID_ALUNO) REFERENCES ALUNO (ID_USUARIO);
ALTER TABLE LANCAMENTO_COMERCIAL ADD CONSTRAINT FK_LANCAMENTO_COMERCIAL_EMPREGADO FOREIGN KEY (ID_EMPREGADO) REFERENCES EMPREGADO (ID_USUARIO);